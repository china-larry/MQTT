...
get_filename_component(_realOrig "/usr/lib/arm-qt5.9.6/lib/cmake/Qt5Mqtt" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Mqtt_install_prefix "/usr/lib/arm-qt5.9.6/lib/../" ABSOLUTE)
else()
...
set(Qt5Mqtt_VERSION_STRING 5.15.0)
...
if (NOT TARGET Qt5::Mqtt)
    ...
    foreach(_module_dep ${_Qt5Mqtt_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.0 ${_Qt5Mqtt_FIND_VERSION_EXACT}
    ...
    _populate_Mqtt_target_properties(RELEASE "libQt5Mqtt.so.5.15.0" "" )
